...
\section{Education}
  \resumeSubHeadingListStart
  	\resumeSubheading
  	{Christian-Albrechts-Universität zu Kiel}{Kiel, Germany}{Ph.D. in Computer Science}{Nov 2020 -- May 2025}
  	\resumeItemListStart
    ...
    \resumeSubheading
      {Chongqing University}{Chongqing, China}
      {Bachelor of Science in Surveying and Mapping Engineering (Geo-informatics)}{Sep 2013 -- June 2017}
...
\section{Experience}
  \resumeSubHeadingListStart
  \resumeSubheading
  {Dandy -- Digital Dental Lab}{New York, US}
  {ML Engineer II -- Computer Vision}{June 2025 -- Present}
  \resumeItemListStart
  	\resumeItem{Shade Capture}{Research and develop methodologies to capture the geometry and radiometric properties of human teeth/crowns/dentures using image-based 3D modeling and inverse rendering.}
  	\resumeItem{ML for Manufacturing}{Developed methodologies to apply computer vision and machine learning in the automatic dental crown manufacturing process.}
  \resumeItemListEnd
   \resumeSubheading
  	{Christian-Albrechts-Universität zu Kiel}{Kiel, Germany}
  	{Computer Vision Research Assistant at Marine Data Science Group (MDS)}{July 2023 -- May 2025}
  	\resumeItemListStart

		\resumeItem{Open-Source C++ Underwater Mapping Software}{Integrate the refractive camera models and refractive SfM into the popular C++ based open-source 3D reconstruction software COLMAP. (project link: \href{https://cau-git.rz.uni-kiel.de/inf-ag-koeser/colmap_underwater}{gitlab:colmap-underwater})}
	  	\resumeItem{Underwater Neural Radiance Field}{Learning a medium- and light-independent scene representation by modeling the camera-attached co-moving light source with spatial- and surface normal-dependent neural network (paper: [1]).}
  		\resumeItem{Tiny- and Semi-transparent Object Reconstruction}{Learning a volumetric representation for tiny- and semi-transparent objects using differentiable rendering and neural radiance field (paper: [8]).}
  		\resumeItem{Teaching Assistant - Probabilistic Robotics (Winter 2023)}{Responsible for the tutorial sessions and the final exam.}
  \resumeItemListEnd

    \resumeSubheading
      {Helmholtz Centre for Ocean Research, Kiel, GEOMAR}{Kiel, Germany}
      {Computer Vision Research Assistant at Oceanic Machine Vision Group (OMV)}{Nov 2020 -- June 2023}
      \resumeItemListStart
        \resumeItem{Refractive Camera Models and Calibration}
    ...
    \resumeSubheading
      ...
      {Working as a freelancer to offer small-to-medium size computer vision services and solutions}{2021 -- 2024}
      \resumeItemListStart
      	...
      	\resumeItem{Intrinsic \& Extrinsic Calibration of a Camera Array}{Develop a calibration method to calibrate the intrinsic and relative extrinsic parameters of a 26-cameras camera array for medical human-body scanning.}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
...
\section{Skills}
  \resumeSubHeadingListStart
  	\resumeItem{Skill Set}{Camera Calibration; 3D Reconstruction; SfM / SLAM; Estimation and Optimization; Representation Learning; Inverse Rendering}
    ...
    \resumeSubItem{Communication}
      {English (proficient); German (basic); Chinese (native)}
  \resumeSubHeadingListEnd
...
18 publications listed on Google Scholar, with a total of 232 citations and an H-index of 8. Below are selected publications:
 \resumeSubHeadingListStart
 \resumeItem{[1]}{\textbf{M. She}, F. Seegr\"aber, D. Nakath, P. Sch\"ontag, K. K\"oser. Relative Illumination Fields: Learning Medium and Light Independent Underwater Scenes. In \textit{ICCV, 2025}}
