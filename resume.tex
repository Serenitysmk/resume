...
\section{Erfahrung}
  ...
  \resumeItemListEnd
    ...
    \resumeSubheading
      {Helmholtz Centre for Ocean Research, Kiel, GEOMAR}{Kiel, Deustchland}
    ...
    \resumeSubheading
      ...
      \resumeSubheading
      {Computer Vision Freelancer}{Kiel, Deustchland}
...
\section{Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Communication}
      {English (flie\ss end); Deustch (Grundkenntnisse); Chinese (Muttersprache)}
  \resumeSubHeadingListEnd
