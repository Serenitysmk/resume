...
\textbf{Name}: \textbf{Mengkun She} \\
\textbf{Date of Birth}: 12.08.1995 \\
\textbf{Place of Birth}: Yunnan, China\\
...
\section{Education}
  ...
  {Bachelor of Science}{Sep 2013 -- June 2017}
	  \resumeItemListStart
	  	\resumeItem{Course of Study}{Surveying and Mapping Engineering (Geo-informatics)}
	  	\resumeItem{Number of Semesters}{8}
      \resumeItemListEnd
 ...
 \resumeItemListStart
 \resumeItem{Course of Study}{Surveying and Mapping Engineering (Geo-informatics)}
 \resumeItem{Number of Semesters}{6}
 \resumeItemListEnd
  	\resumeSubheading
  	{Christian-Albrechts-Universität zu Kiel}{Kiel, Germany}{Ph.D. in Computer Science}{Nov 2020 -- Present}
  	\resumeItemListStart
  		\resumeItem{Course of Study}{Computer Science}
  		\resumeItem{Number of Semesters}{9}
  		\resumeItem{Supervisor}{Prof. Kevin K\"oser}
  		\resumeItem{Title of Dissertation}{Underwater Refractive Camera Calibration and 3D Scene Reconstruction}
  	\resumeItemListEnd
...
%  	{Computer Vision Research Assistant at Marine Data Science Group (MDS)}{July 2023 -- Present}
%  	\resumeItemListStart
%
...
%\section{Skills}
%  \resumeSubHeadingListStart
%  	\resumeItem{Skill Set}{Camera Calibration; 3D Reconstruction; SfM / SLAM; Estimation and Optimization; Representation Learning;}
